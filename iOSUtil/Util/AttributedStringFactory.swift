...
class AttributedStringFactory: NSObject {
    ...
    private var completion: (_ result: Result<NSMutableAttributedString, NSError>) -> Void
    ...
    // MARK: LifeCycle
    init(_ origin: String, html: String, fontSize: CGFloat, completion: @escaping (_ result: Result<NSMutableAttributedString, NSError>) -> Void) {
    ...
    class func create(_ str: String, fontFamily: String? = nil, fontSize: CGFloat, fontColor: String? = nil, completion: @escaping (_ result: Result<NSMutableAttributedString, NSError>) -> Void) {
